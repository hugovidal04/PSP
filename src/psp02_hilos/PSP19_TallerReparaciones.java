...
class Cine {
    ...
    public Cine(int numBahias, int capacidadCola) {
...
class Mecanico implements Runnable {
    private final int id;
    private final Cine taller;

    public Mecanico(int id, Cine taller) {
        this.id = id;
        this.taller = taller;
    }
...
class GeneradorAutos implements Runnable {
    ...
    public GeneradorAutos(Cine taller, int tiempoLlegadaMax) {
        this.taller = taller;
...
public class PSP19_TallerReparaciones {
	...
	public static void main(String[] args) {
        ...
        Cine taller = new Cine(NUM_BAHIAS, CAPACIDAD_COLA);
